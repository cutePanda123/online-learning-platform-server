...
class Client(Iface):
    ...
    def sendTextMessage(self, phone, message):
        ...
        """
        self.send_sendTextMessage(phone, message)
        return self.recv_sendTextMessage()

    def send_sendTextMessage(self, phone, message):
...
class Processor(Iface, TProcessor):
    ...
    def process_sendTextMessage(self, seqid, iprot, oprot):
        ...
        result = sendTextMessage_result()
        try:
            result.success = self._handler.sendTextMessage(args.phone, args.message)
        ...
        oprot.writeMessageBegin("sendTextMessage", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class sendTextMessage_args(object):
    """
    Attributes:
     - phone
     - message
...
all_structs.append(sendTextMessage_args)
sendTextMessage_args.thrift_spec = (
    None,  # 0
...
class sendTextMessage_result(object):
    """
    Attributes:
     - success
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(sendTextMessage_result)
sendTextMessage_result.thrift_spec = (
